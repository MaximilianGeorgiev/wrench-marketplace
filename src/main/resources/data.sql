...
DROP TABLE IF EXISTS USER_WATCHEDLISTING;
...
ALTER TABLE LISTING_IMAGE ADD FOREIGN KEY (listing_Id) REFERENCES LISTING(Id);
ALTER TABLE LISTING_IMAGE ADD FOREIGN KEY (image_Id) REFERENCES IMAGE(Id);
...
INSERT INTO LISTING (Id, title, price, description, category_name, phone_number) VALUES (1, 'asdf', 15.00, 'asdf', 'Car parts', '125125');
INSERT INTO USER_LISTING (user_Id, listing_Id) VALUES (1,1);

CREATE TABLE USER_WATCHEDLISTING(
user_Id INT NOT NULL,
listing_Id INT NOT NULL);

ALTER TABLE USER_WATCHEDLISTING ADD FOREIGN KEY (user_Id) REFERENCES USERS(Id) ON UPDATE CASCADE;
ALTER TABLE USER_WATCHEDLISTING ADD FOREIGN KEY (listing_Id) REFERENCES LISTING(Id) ON UPDATE CASCADE;
